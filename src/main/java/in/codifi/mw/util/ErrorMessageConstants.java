...
public class ErrorMessageConstants {
	...
	public static final String INVALID_EXCHANGE = "Invalid parameter : 'exchange' Accepts only {'ALL','NSEEQ','NSEFO','BSEEQ','BSEFO','NSECURR','BSECURR','MCXCOMM','NCDEXCOMM','NSECOMM'}";
	...
	public static final String INVALID_EXCHANGE_INFO = "Invalid parameter : 'exchange' Accepts only {'NSEEQ','NSEFO','BSEEQ','BSEFO','NSECURR','BSECURR','MCXCOMM','NCDEXCOMM','NSECOMM'}";
